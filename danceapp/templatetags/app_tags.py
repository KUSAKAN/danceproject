...
from danceapp.models import Category, Post
from danceapp.forms import PostSearchForm
...
@register.inclusion_tag('danceapp/templates/includes/category_links.html')
def render_category_links():
    return {
        'category_list': Category.objects.all(),
    }

@register.inclusion_tag('danceapp/templates/includes/month_links.html')
def render_month_links():
    return {
        'dates': Post.objects.published().dates('published', 'month', order='DESC'),
    }

@register.inclusion_tag('danceapp/templates/includes/search_form.html')
